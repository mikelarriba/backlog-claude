...
// Anything shaped like a Confluence suggestion (action + before/after content)
// can be diffed — documentation.ts's ConfluenceSuggestion satisfies this.
export interface DiffableSuggestion {
...
export function diffLinesForSuggestion(s: DiffableSuggestion): DiffLine[] {
  if (s.action === 'Create') {
...
export function renderDiffHtml(s: DiffableSuggestion): string {
