...
import { computeLineDiff, renderDiffLinesHtml } from './lineDiff.js';
import type { DiffLine } from './lineDiff.js';
...
// ── Diff rendering ───────────────────────────────────────────────────────────
// The generic diff algorithm and its HTML rendering live in lineDiff.ts;
// this dispatch on ConfluenceSuggestion.action is documentation.ts-specific.
...
function _renderDiffHtml(s: ConfluenceSuggestion): string {
  return renderDiffLinesHtml(_diffLinesForSuggestion(s));
}
