...
export function compactLayout(positions) {
...
export function computeEdgeMovePosition(direction, cur, positions) {
  switch (direction) {
    case 'left':
...
export function buildBlocksAndParallel(childFilenames, lookupDoc) {
...
export function computeSecEdges(layout, blocks) {
  const byCol = new Map();
