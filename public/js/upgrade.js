...
export async function executeUpgrade() {
    ...
    try {
        ...
        await streamSSE(`/api/doc/${currentDocType}/${encodeURIComponent(currentFilename)}/upgrade`, { feedback }, {
            onText: (text) => {
        ...
        if (finalContent) {
            document.getElementById('detail-content').innerHTML = renderMarkdown(stripFrontmatter(finalContent));
        }
